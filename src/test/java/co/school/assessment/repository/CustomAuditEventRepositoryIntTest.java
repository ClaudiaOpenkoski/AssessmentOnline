package co.school.assessment.repository;

import co.school.assessment.TestFrontendApp;
import co.school.assessment.config.Constants;
import co.school.assessment.config.audit.AuditEventConverter;
import co.school.assessment.domain.PersistentAuditEvent;
...
import static co.school.assessment.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
